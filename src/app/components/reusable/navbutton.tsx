...
const NavButton = ({ Icon, title, href }: ButtonItemProps) => {
  return (
    <Link to={href}>
      <Card
        className="bg-transparent transition-all duration-300 opacity-75 hover:opacity-100 hover:bg-gradient-to-br from-bg-light to-bg-dark h-14 w-fit pr-4 flex items-center justify-start cursor-pointer"
        sx={{
          borderRadius: "14px",
