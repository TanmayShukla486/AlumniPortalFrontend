    ...
    <div className="w-full h-full bg-gradient-to-br from-bg-light to-bg-dark shadow-custom border-4 border-white rounded-xl">
      <div className="bg-gradient-to-b from from-white to-content-light bg-clip-text p-8 flex flex-col items-center justify-center">
        ...
        <div className="text-xl text-transparent mt-8 text-justify leading-loose">
          ...
          posts, discover events, and participate in discussions that matter to
          you. Students can interact with alumni for guidance and inspiration,
          while alumni can share their experiences and insights, helping the
          next generation achieve their goals. Join us in celebrating our shared
          history and building a brighter future together. Your story
          matters—let’s connect!
        </div>
      </div>
    </div>
  )
